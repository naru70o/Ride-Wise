...
function Header() {
  return (
    <header className="h-screen max-w-[120rem] grid col-start-2 m-0 mx-auto col-span-10">
      <nav className="flex justify-between items-center mt-[2rem]">
        ...
        <ul className="flex text-[2.4rem] items-center transition-all text-deep-brown xl:text-[2rem] md:text-[1.6rem] flex-row gap-[2rem] sm:gap-[1rem]">
